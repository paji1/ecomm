import Slider, { RangeProps } from "rc-slider"; // Import RangeProps if available
...
const Range = createSliderWithTooltip(
	Slider.Range
) as React.ComponentType<RangeProps>;
...
const ProductsFilter = () => {
	...
	return (
		<form className="products-filter" onChange={addQueryParams}>
			...
			>
				Ajouter un filtre <i className="icon-down-open" />
			</button>
			...
			>
				<div className="products-filter__block">
					<button type="button">Type de produit</button>
